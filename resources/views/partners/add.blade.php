...
<div class="card">
            ...
            <div class="panel panel-primary m-t-15">
                        <div class="panel-heading"><strong>Instructions pour les partenaires et les contacts</strong></div>
                        <div class="panel-body">
                            Les partenaires et les contacts peuvent étre soit des mandataires du réseau Styl'immo, ou des agences, des promoteurs ou mandataires externes, vous pouvez les solliciter pour 
                            conseils ou les associer à une affaire dans le cas ou c'est des mandataires du réseau ou des notaires.
                            <br>
                            Pour ajouter un mandataire directement depuis le réseau Styl'immo cliquez sur le bouton suivant. 
                            <br>
                            <br>
                            <a href="{{route('partners.fromnetwork')}}" class="btn btn-warning btn-flat btn-addon m-b-10 m-l-5"><i class="ti-plus"></i>@lang('Ajouter depuis le réseau')</a>
                        </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form class="form-valide" action="{{ route('partners.add') }}" method="post">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="val-lastname">Nom ou raison sociale<span class="text-danger">*</span></label>
                            <div class="col-lg-4">
                            <input type="text" class="form-control {{$errors->has('val-lastname') ? 'is-invalid' : ''}}" value="{{old('val-lastname')}}" id="val-lastname" name="val-lastname" placeholder="Ex: SARL Nexitic.." required>
                        ...
                        <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-firstname">Prénom</label>
                                <div class="col-lg-4">
                                <input type="text"  class="form-control {{ $errors->has('val-firstname') ? ' is-invalid' : '' }}" value="{{old('val-firstname')}}" id="val-firstname" name="val-firstname" placeholder="Prénom..">
                        ...
                        <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-phone">Téléphone<span class="text-danger">*</span></label>
                                <div class="col-lg-2">
