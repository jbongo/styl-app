...
<body>
        ...
        <p> </p>
        <p><strong><u>FORFAIT D’ENTREE</u></strong><strong> :</strong>    <strong>{{$forfait}}</strong> € H.T.</p>
        <p>Ouverture des comptes administratifs internes et externes (attestation de négociateur immobilier etc.).</p>
        @if($refund == 1)
        <p>Remboursé sur la première vente qui devra être effectuée dans les <strong>{{$duration}}</strong> mois suivant le début d’activité.</p>
        @endif
        <p> </p>
