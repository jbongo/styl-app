      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="form-validation">
               <form class="form-valide3" action="{{ route('contrat.expert.update', $model->id) }}" method="post">
                  {{ csrf_field() }}
   ...
   $('.submit').click(function(e){ 
      ...
      if (form.valid() === true){
        ...
        var planname = $('#plan-name').val();
          $.ajax({
              type: "POST",
              url: ("{{ route('contrat.expert.update', $model->id)}}"),
              ...
              data: {
                  ...
                  freeduration: $('#free-duration').val(), minsales: $('#min-sales').val(),
