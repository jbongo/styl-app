                                                                        ...
                                                                        <div class="tab-content">
                                                                            <div role="tabpanel" class="tab-pane active" id="1">
                                                                                <div class="contact-information">
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Civilité'):</span>
                                                                                        <span class="phone-number">{{$acquereur->civilite_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Nom'):</span>
                                                                                        <span class="phone-number">{{$acquereur->nom_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="website-content">
                                                                                        <span class="contact-title">@lang('Prénom'):</span>
                                                                                        <span class="contact-website">{{$acquereur->prenom_partenaire}}</span>
                                                                                    </div>
                                                                                    
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Téléphone Mobile'):</span>
                                                                                        <span class="phone-number">{{$acquereur->telephone_mobile_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Téléphone Fixe'):</span>
                                                                                        <span class="phone-number">{{$acquereur->telephone_fixe_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="birthday-content">
                                                                                        <span class="contact-title">@lang('Email'):</span>
                                                                                        <span class="birth-date">{{$acquereur->email_partenaire}}</span>
                                                                                    </div>       
            
                                                                                    <div class="skype-content">
                                                                                        <span class="contact-title">@lang('Adresse'):</span>
                                                                                        <span class="contact-skype">{{$acquereur->adresse_partenaire}}</span>
                                                                                    </div>
                                                                                    
                                                                                    <div class="address-content">
                                                                                        <span class="contact-title">@lang('Code postal'):</span>
                                                                                        <span class="mail-address">{{$acquereur->code_postal_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="gender-content">
                                                                                        <span class="contact-title">@lang('Ville'):</span>
                                                                                        <span class="gender">{{$acquereur->ville_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Pays'):</span>
                                                                                        <span class="phone-number">{{$acquereur->pays_partenaire}}</span>
                                                                                    </div>                                                                                                                                           
            
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Date de naissance'):</span>
                                                                                        <span class="phone-number">{{$acquereur->date_naissance_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Lieu de naissance'):</span>
                                                                                        <span class="phone-number">{{$acquereur->lieu_naissance_partenaire}}</span>
                                                                                    </div>
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Langue'):</span>
                                                                                        <span class="phone-number">{{$acquereur->langue_partenaire}} </span>
                                                                                    </div>
                                                                                    <div class="phone-content">
                                                                                        <span class="contact-title">@lang('Note'):</span>
                                                                                        <span class="phone-number">{{$acquereur->note_partenaire}} </span>
                                                                                    </div>
