<div class="card-body">
    ...
    <form class="form-valide" action="{{ route('acquereurs.update',$acquereur->id) }}" method="post">
        {{ csrf_field() }}
        <input type="hidden" class="" value="couple" name="type_acquereur">
                        ...
                        <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="js-select2 form-control {{$errors->has('civilite1') ? 'is-invalid' : ''}}" id="civilite1" name="civilite1" style="width: 100%;" data-placeholder="Choose one.." required>
                                               ...
                                               @if(isset($acquereur->civilite))
                                                <option value="{{$acquereur->civilite}}">{{$acquereur->civilite}}</option>
                                               @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                <input type="text" class="form-control {{$errors->has('nom1') ? 'is-invalid' : ''}}" value="{{old('nom1') ? old('nom1') : $acquereur->nom }}" id="nom1" name="nom1" placeholder="Nom.." required>
                                    @if ($errors->has('nom1'))
                                        <br>
                                        <div class="alert alert-warning ">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                    <input type="text"  class="form-control {{ $errors->has('prenom1') ? ' is-invalid' : '' }}" value="{{old('prenom1') ? old('prenom1') : $acquereur->prenom}}" id="prenom1" name="prenom1" placeholder="Prénom.." >
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                    <input type="text"  class="form-control {{ $errors->has('categorie1') ? ' is-invalid' : '' }}" value="{{old('categorie1') ? old('categorie1') : $acquereur->categorie }}" id="categorie1" name="categorie1" placeholder="VIP ect." >
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control {{ $errors->has('email1') ? ' is-invalid' : '' }}" id="email1" value="{{old('email1') ? old('email1') : $acquereur->email}}" name="email1" placeholder="Email.." required>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control " value="{{old('telephone_fixe1') ? old('telephone_fixe1') : $acquereur->telephone_fixe}}" id="telephone_fixe1" name="telephone_fixe1" placeholder="Ex: 0600000000.." >
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" value="{{old('telephone_mobile1') ? old('telephone_mobile1') : $acquereur->telephone_mobile}}" id="telephone_mobile1" name="telephone_mobile1" placeholder="Ex: 0600000000.." >
        ...
        <div class="col-md-6 col-lg-6">
                ...
                <fieldset>   
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="js-select2 form-control {{$errors->has('civilite2') ? 'is-invalid' : ''}}" id="civilite2" name="civilite2" style="width: 100%;" data-placeholder="Choose one.." required>
                                        ...
                                        @if(isset($acquereur->civilite_partenaire))
                                            <option value="{{$acquereur->civilite_partenaire}}">{{$acquereur->civilite_partenaire}}</option>
                                        @endif
                                        <option value="Mr">@lang('M.') </option>
                                        <option value="Mme">@lang('Mme.') </option>
                                        <option value="Mlle">@lang('Mlle.') </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                        <input type="text" class="form-control " value="{{old('nom2') ? old('nom2') : $acquereur->nom_partenaire}}" id="nom2" name="nom2" placeholder="Nom.." required>
                            @if ($errors->has('nom2'))
                                <br>
                                <div class="alert alert-warning ">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                            <input type="text"  class="form-control" value="{{old('prenom2') ? old('prenom2') : $acquereur->prenom_partenaire}}" id="prenom2" name="prenom2" placeholder="Prénom.." >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control " value="{{old('telephone_fixe2')? old('telephone_fixe2') : $acquereur->telephone_fixe_partenaire}}" id="telephone_fixe2" name="telephone_fixe2" placeholder="Ex: 0600000000.." >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" value="{{old('telephone_mobile2') ? old('telephone_mobile2') : $acquereur->telephone_mobile_partenaire}}" id="telephone_mobile2" name="telephone_mobile2" placeholder="Ex: 0600000000.." >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" id="email2" value="{{old('email2')  ? old('email2') : $acquereur->email_partenaire}}" name="email2" placeholder="Email.." required>
            ...
            <div class="col-md-6 col-lg-6">
                <fieldset>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control " value="{{old('adresse1') ? old('adresse1') : $acquereur->adresse}}" id="adresse1" name="adresse1" placeholder="N° et Rue.." >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                            <input type="text" class="form-control " value="{{old('code_postal1') ? old('code_postal1') : $acquereur->code_postal}}" id="code_postal1" name="code_postal1" placeholder="Ex: 75001.." >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" value="{{old('ville1') ? old('ville1') : $acquereur->ville}}" id="ville1" name="ville1" placeholder="EX: Paris.." >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control " value="{{old('pays1') ? old('pays1') : $acquereur->pays}}" id="pays1" name="pays1" placeholder="Entez une lettre et choisissez.." >
                        @if ($errors->has('pays1'))
                            <br>
                            <div class="alert alert-warning ">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="date" class="form-control" value="{{old('date_naissance1') ? old('date_naissance1') : $acquereur->date_naissance }}" id="date_naissance1" name="date_naissance1"  >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="text" class="form-control " value="{{old('lieu_naissance1') ? old('lieu_naissance1') : $acquereur->lieu_naissance }}" id="lieu_naissance1" name="lieu_naissance1" placeholder="EX: Paris.." >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control " value="{{old('langue1') ? old('langue1') : $acquereur->langue }}" id="langue1" name="langue1" placeholder="EX: Français.." >
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-lg-6">
                               <textarea class="form-control" id="note1" name="note1"  rows="3" placeholder="" >{{old('note1') ? old('note1') : $acquereur->note}}</textarea>
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <fieldset>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control " value="{{old('adresse2')  ? old('adresse2') : $acquereur->adresse_partenaire }}" id="adresse2" name="adresse2" placeholder="N° et Rue.." >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                <input type="text" class="form-control " value="{{old('code_postal2')  ? old('code_postal2') : $acquereur->code_postal_partenaire}}" id="code_postal2" name="code_postal2" placeholder="Ex: 75001.." >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control " value="{{old('ville2')  ? old('ville2') : $acquereur->ville_partenaire}}" id="ville2" name="ville2" placeholder="EX: Paris.." >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control " value="{{old('pays2') ? old('pays2') : $acquereur->pays_partenaire }}" id="pays2" name="pays2" placeholder="Entez une lettre et choisissez.." >
                            @if ($errors->has('pays2'))
                                <br>
                                <div class="alert alert-warning ">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" class="form-control " value="{{old('date_naissance2') ? old('date_naissance2') : $acquereur->date_naissance_partenaire}}" id="date_naissance2" name="date_naissance2"  >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" value="{{old('lieu_naissance2')  ? old('lieu_naissance2') : $acquereur->lieu_naissance_partenaire}}" id="lieu_naissance2" name="lieu_naissance2" placeholder="EX: Paris.." >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control " value="{{old('langue2')  ? old('langue2') : $acquereur->langue_partenaire}}" id="langue2" name="langue2" placeholder="" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <textarea class="form-control" id="note2" name="note2"  rows="3" placeholder="" >{{old('note2') ? old('note2') : $acquereur->note_partenaire}}</textarea>
                                <span class="help-block">
                                <small></small>
                                </span>
                            </div>
