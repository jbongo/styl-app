    ...
    <h2>@lang('Modifier le groupe ') "{{$groupe->nom_groupe}}"</h2>
        ...
        <div class="card-body">
            ...
            <div class="form-validation">
                    <form class="form-valide" id="formgroupe" action="{{ route('groupeacquereur.update', $groupe->id) }}" enctype="multipart/form-data" method="post">
                        {{ csrf_field() }}
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <select class="selectpicker col-lg-6" id="membre_succession" name="membre_succession" data-live-search="true" data-style="btn-warning" >
                                                    ...
                                                    @foreach($acquereur_non_membres as $acquereur_non_membre)
                                                    
                                                        <option  value="{{$acquereur_non_membre->id}}" mail="{{$acquereur_non_membre->email}}" data-tokens="{{$acquereur_non_membre->nom}} {{$acquereur_non_membre->prenom}}">{{$acquereur_non_membre->civilite}}  {{$acquereur_non_membre->nom}} {{$acquereur_non_membre->prenom}}</option>
                                        ...
                                        <table  id="example" class=" table student-data-table  m-t-20 "  style="width:70%">
                                            ...
                                            @foreach ($groupe->acquereurs as $associe)
                                                <tr>
                                                    ...
                                                    <td>
                                                            <span><a href="{{route('acquereurs.edit',$associe->id)}}" data-toggle="tooltip" title="@lang('Modifier ') {{ $associe->nom}} "><i class="ti-pencil-alt color-success"></i></a></span>
                                                    </td>
                                                                                        
                                    
                                                    <td>
                                                        <span><a  href="{{route('acquereurs.retirer',[$groupe->id, $associe->id])}}" class="dissocier" data-toggle="tooltip" title="@lang('Dissocier ') {{ $associe->nom }}"><i class="btn ti-close  color-danger"></i> </a></span>
                                                    </td>
                                                </tr>
                                        @endforeach
                                        </tbody>
