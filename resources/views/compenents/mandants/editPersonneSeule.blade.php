                    ...
                    <fieldset> 
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                    <input type="text" class="form-control {{$errors->has('nom') ? 'is-invalid' : ''}}" value="{{ old('nom') ? old('nom') :  $mandant->nom}}" id="nom" name="nom" placeholder="Nom.." required>
                                        @if ($errors->has('nom'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                        <input type="text"  class="form-control {{ $errors->has('prenom') ? ' is-invalid' : '' }}" value="{{old('prenom') ? old('prenom') :  $mandant->prenom }}" id="prenom" name="prenom" placeholder="Prénom.." >
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                        <input type="text"  class="form-control {{ $errors->has('categorie') ? ' is-invalid' : '' }}" value="{{old('categorie') ? old('categorie') :  $mandant->categorie }}" id="categorie" name="categorie" placeholder="VIP ect." >
            ...
            <div class="col-md-6 col-lg-6">
                    ...
                    <fieldset>   
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control " id="val-email" value="{{old('email')  ? old('email') :  $mandant->email }}" name="email" placeholder="Email.." required>
                                    @if ($errors->has('email'))
                                    <br>
                                    <div class="alert alert-warning ">
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" value="{{old('telephone_mobile')  ? old('telephone_mobile') :  $mandant->telephone_mobile }}" id="telephone_mobile" name="telephone_mobile" placeholder="Ex: 0600000000.." >
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control " value="{{old('telephone_fixe') ? old('telephone_fixe') :  $mandant->telephone_fixe }}" id="telephone_fixe" name="telephone_fixe" placeholder="Ex: 0600000000.." >
                ...
                <div class="col-md-6 col-lg-6">
                    <fieldset>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" value="{{old('adresse') ? old('adresse') :  $mandant->adresse }}" id="adresse" name="adresse" placeholder="N° et Rue.." >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                <input type="text" class="form-control" value="{{old('code_postal') ? old('code_postal') :  $mandant->code_postal}}" id="code_postal" name="code_postal" placeholder="Ex: 75001.." >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control " value="{{old('ville') ? old('ville') :  $mandant->ville }}" id="ville" name="ville" placeholder="EX: Paris.." >
                                @if ($errors->has('ville'))
                                    <br>
                                    <div class="alert alert-warning ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" value="{{old('pays') ? old('pays') :  $mandant->pays }}" id="pays" name="pays" placeholder="Entez une lettre et choisissez.." >
                            @if ($errors->has('pays'))
                                <br>
                                <div class="alert alert-warning ">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="date" class="form-control " value="{{old('date_naissance')? old('date_naissance') :  $mandant->date_naissance}}" id="date_naissance" name="date_naissance"  >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control " value="{{old('lieu_naissance') ? old('lieu_naissance') :  $mandant->lieu_naissance}}" id="lieu_naissance" name="lieu_naissance" placeholder="EX: Paris.." >
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <fieldset>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control " value="{{old('langue') ? old('langue') :  $mandant->langue}}" id="langue" name="langue"  >
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" id="note" name="note"  rows="3" placeholder="" >{{old('note') ? old('note') : $mandant->note}}</textarea>
