<div class="card-body">
     ...
     @endif
        ...
        <div class="form-validation">
            <form class="form-valide" id="formgroupe" action="{{ route('mandants.add') }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <select class="selectpicker col-lg-6" id="membre_succession" name="membre_succession" data-live-search="true" data-style="btn-warning" >
                                            ...
                                            @foreach($mandant_seuls as $mandant_seul)
                                                ...
                                                <option  value="{{$mandant_seul->id}}" mail="{{$mandant_seul->email}}" data-tokens="{{$mandant_seul->nom}} {{$mandant_seul->prenom}}">{{$mandant_seul->civilite}}  {{$mandant_seul->nom}} {{$mandant_seul->prenom}}</option>
