<div class="card-body">
     ...
     @endif
        ...
        <div class="form-validation">
            <form class="form-valide" action="{{ route('mandants.update',$mandant->id) }}" enctype="multipart/form-data" method="post">
                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select class="js-select2 form-control" id="forme_juridique" name="forme_juridique_pm" style="width: 100%;" data-placeholder="Choose one.." required>
                                                        ...
                                                        @if(isset($mandant->forme_juridique))
                                                            <option value="{{$mandant->forme_juridique}}" >{{$mandant->forme_juridique}}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                        <input type="text" class="form-control " value="{{old('raison_sociale_pm') ? old('raison_sociale_pm') : $mandant->raison_sociale }}" id="raison_sociale" name="raison_sociale_pm" placeholder="" required>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" value="{{old('telephone_fixe_pm')  ? old('telephone_fixe_pm') : $mandant->telephone_fixe}}" id="telephone_fixe" name="telephone_fixe_pm" placeholder="Ex: 0600000000.." >
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" value="{{old('telephone_mobile_pm')  ? old('telephone_mobile_pm') : $mandant->telephone_mobile}}" id="telephone_mobile" name="telephone_mobile_pm" placeholder="Ex: 0600000000.." >
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control " id="val-email" value="{{old('email_pm')  ? old('email_pm') : $mandant->email}}" name="email_pm" placeholder="Email.." required>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control " value="{{old('adresse_pm')  ? old('adresse_pm') : $mandant->adresse}}" id="adresse" name="adresse_pm" placeholder="N° et Rue.." >
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="text" class="form-control" value="{{old('code_postal_pm')  ? old('code_postal_pm') : $mandant->code_postal}}" id="code_postal" name="code_postal_pm" placeholder="Ex: 75001.." >
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control " value="{{old('ville_pm')  ? old('ville_pm') : $mandant->ville}}" id="ville" name="ville_pm" placeholder="EX: Paris.." >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control " value="{{old('pays_pm')  ? old('pays_pm') : $mandant->pays}}" id="pays" name="pays_pm" placeholder="Entez une lettre et choisissez.." >
                ...
                <div class="col-md-6 col-lg-6">
                        ...
                        <fieldset>   
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" value="{{old('siret_pm')  ? old('siret_pm') : $mandant->siret}}" id="siret" name="siret_pm" placeholder="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" id="note" name="note_pm"  rows="5" placeholder="" >{{old('note_pm') ? old('note_pm') : $mandant->note}}</textarea>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <select class="selectpicker col-lg-6" id="contact_associe" name="contact_associe" data-live-search="true" data-style="btn-warning" >
                                            ...
                                            @foreach($mandant_non_associe as $mandant_seul)
                                ...
                                <table  id="example" class=" table student-data-table  m-t-20 "  style="width:70%">
                                    ...
                                    @foreach ($mandant->mandants_associe as $associe)
                                        <tr>
                                            ...
                                            <td>
                                                <span><a  href="{{route('mandants.dissocier',[$mandant->id, $associe->id])}}" class="dissocier" data-toggle="tooltip" title="@lang('Dissocier ') {{ $associe->nom }}"><i class="btn ti-close  color-danger"></i> </a></span>
                                            </td>
                                        </tr>
                                @endforeach
                                  </tbody>
