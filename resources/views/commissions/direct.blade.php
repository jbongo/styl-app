...
*@description : formulaire d'ajout d'un model de commissions directes
*/
      ...
      <div class="card">
         <div class="col-lg-10">
            <div class="panel panel-danger m-t-15">
               <div class="panel-heading"><strong>Models de rémunération directe</strong></div>
               <div class="panel-body">
                  Ici vous pouvez créer des models de rémunération directe pour les mandataires du réseau, vous pouvez définir leurs pourcentage de départ et leurs mettre en place un système de paliers, 
                  ...
                  <br>
                  Pour une rémunération à 100% veuillez désactiver les paliers en mettant le bouton sur non et mettre le pourcentage du mandataire à 100.
               </div>
            </div>
         </div>
         <div class="card-body">
            <div class="form-validation">
               <form class="form-valide3" action="{{ route('direct.add') }}" method="post">
                  {{ csrf_field() }}
                     ...
                     <div class="col-lg-10">
                        <div class="card alert nestable-cart">
                           ...
                           <div class="rangeslider">
                              <div>
                                 <input type="text" id="range_01" value="" name="range_01" />
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="form-group row" id="max-starter-parrent">
                     <div class="col-lg-4">
                        <label class="col-lg-8 col-form-label" for="max-starter">Durée maximum du pack Starter<span class="text-danger">*</span></label>
