...
@section('content')
    ...
    @endsection
        ...
        <div class="card alert">
            <a href="{{route('mandants.index')}}" class="btn btn-warning btn-flat btn-addon m-b-10 m-l-5"><i class="ti-arrow-left "></i>@lang('Liste des mandants')</a>
            <br>
            <br>
            <h2>@lang('Ajouter un mandant')</h2>
            <p></p>
            ...
            <div class="tab-content">
                ...
                <h3></h3>
                <p>@include('compenents.mandants.addPersonneSeule')</p>
                </div>
                ...
                <div id="menu3" class="tab-pane fade">
                    <p>@include('compenents.mandants.addSuccession')</p>
                </div>
